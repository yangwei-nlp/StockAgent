...
from src.loader.splitter import split_docs_to_chunks
...
if __name__ == "__main__":
    ...
    config = configuration.Configuration()  # Customize your config here
    configuration.init_config(config=config)

    load_from_local_files(
        paths_or_directory=[
            "/Users/younger/Desktop/yw/myKB/小司/2025-10/[2025-10-09 13-19-44][小司频道][别说了，我是乌鸦嘴😩]_原文.docx",
        ],
        collection_name="my_collection",
        collection_description="This is a collection of documents about quantum computing.",
