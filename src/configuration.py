...
from src.agent import ChainOfRAG, DeepSearch, NaiveRAG
from src.agent.rag_router import RAGRouter
...
class Configuration:
    """
    Configuration class for src.

    This class manages the configuration settings for various components of the src system,
...
class ModuleFactory:
    """
    Factory class for creating instances of various modules in the src system.
    ...
    def _create_module_instance(self, feature: FeatureType, module_name: str):
        ...
        # e.g.
        # feature = "file_loader"
        # module_name = "src.loader.file_loader"
    ...
    def create_llm(self) -> BaseLLM:
        ...
        """
        return self._create_module_instance("llm", "src.llm")
    ...
    def create_embedding(self) -> BaseEmbedding:
        ...
        """
        return self._create_module_instance("embedding", "src.embedding")
    ...
    def create_file_loader(self) -> BaseLoader:
        ...
        """
        return self._create_module_instance("file_loader", "src.loader.file_loader")
    ...
    def create_web_crawler(self) -> BaseCrawler:
        ...
        """
        return self._create_module_instance("web_crawler", "src.loader.web_crawler")
    ...
    def create_vector_db(self) -> BaseVectorDB:
        ...
        """
        return self._create_module_instance("vector_db", "src.vector_db")
